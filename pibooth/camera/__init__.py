...
def close_proxy(rpi_cam2_proxy, gp_cam_proxy, cv_cam_proxy):
    """Close proxy drivers.
    """
    if rpi_cam2_proxy:
        Rpi_Picamera2(rpi_cam2_proxy).quit()
    if gp_cam_proxy:
